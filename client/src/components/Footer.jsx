            ...
            <div className="w-full max-w-7xl mx-auto">
                <div className="grid w-full justify-between sm:flex md:grid-cols-1">
                    ...
                    <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
                        ...
                        <Footer.LinkGroup col>
                            <Footer.Link 
                            href="https://github.com/nishshanka20"
                            target='_blank'
                            rel='noopener noreferrer'>
                                Github
                            </Footer.Link>
                            <Footer.Link 
                            href="https://www.linkedin.com/in/nishshanka-liyana-arachchi-3b0738252/ "
                            target='_blank'
                            rel='noopener noreferrer'>
                                LinkedIn
                            </Footer.Link>
                        ...
                        <Footer.LinkGroup col>
                            ...
                            href="#"
                            //target='_blank'
                            //</Footer.LinkGroup>rel='noopener noreferrer'
                            >
                                Privacy Policy
                            </Footer.Link>
                            <Footer.Link 
                ...
                <div className="w-full sm:flex sm:items-center sm:justify-between">
                    <Footer.Copyright href="#" by="Nisa's blog" year={new Date().getFullYear()}/>
